...
public:
	...
	* Singletonパターン.
	* @return GraphicsDeviceクラスのインスタンス
	*/
	...
	*/
	...
	/**
	* デバイス取得関数
	* @ruturn m_pD3Device		Direct3Dのデバイス
	*/
	inline IDirect3DDevice9* GetDevice(){ return m_pD3Device; };
...
private:
	IDirect3D9*&				m_pDirect3D=g_pDirect3D;		//!< Direct3Dのインターフェイス
	IDirect3DDevice9*&			m_pD3Device=g_pD3Device;		//!< Direct3Dのデバイス
