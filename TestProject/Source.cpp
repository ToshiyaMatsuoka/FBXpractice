...
void Control() {
	...
	if (InputKEY(DIK_SUBTRACT))fPosZ -= 0.01f;
	if (InputKEY(DIK_ADD))fPosZ += 0.01f;
	...
	if (InputKEY(DIK_NUMPAD1))fHeading -= 0.1f;
	if (InputKEY(DIK_NUMPAD3))fHeading += 0.1f;
	if (InputKEY(DIK_NUMPAD7))fPitch -= 0.1f;
	if (InputKEY(DIK_NUMPAD9))fPitch += 0.1f;
	if (InputKEY(DIK_DIVIDE))fRoling -= 0.1f;
